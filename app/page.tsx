...
export default async function Home() {
  return (
    <main className="min-h-screen justify-center p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)] [text-shadow:5px_5px_1em_#dcccb6,5px_5px_1em_#dcccb6,5px_5px_1em_#dcccb6,5px_5px_1em_#dcccb6,5px_5px_1em_#dcccb6,5px_5px_1em_#dcccb6,5px_5px_1em_#dcccb6] flex flex-col sm:flex-row gap-8 items-center text-center">
